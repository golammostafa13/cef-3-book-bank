...
export function fieldClass(error?: string, className?: string) {
  return cn(
    "h-12 w-full rounded-xl border bg-bg px-4 text-[0.95rem] text-ink shadow-[inset_0_1px_2px_rgba(61,45,32,0.06)] placeholder:text-ink-faint focus:outline-none",
    error
